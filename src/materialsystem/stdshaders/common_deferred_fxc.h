...
#define NUM_SHADOWED_COOKIE MAX_LIGHTS_SHADOWEDCOOKIE
#define NUM_SHADOWED MAX_LIGHTS_SHADOWED
#define NUM_COOKIE MAX_LIGHTS_COOKIE
#define NUM_SIMPLE MAX_LIGHTS_SIMPLE
