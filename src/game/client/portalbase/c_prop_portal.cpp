...
CProp_Portal* C_Prop_Portal::FindPortal(unsigned char iLinkageGroupID, bool bPortal2, bool bCreateIfNothingFound)
{
...
const CUtlVector<CProp_Portal*>* C_Prop_Portal::GetPortalLinkageGroup(unsigned char iLinkageGroupID)
{
