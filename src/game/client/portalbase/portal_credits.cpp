...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CHudPortalCredits::CHudPortalCredits( const char *pElementName ) : CHudElement( pElementName ), BaseClass( NULL, "HudPortalCredits" )
{
...
void CHudPortalCredits::DrawPortalOutroCreditsName( void )
{
	...
	if (gpGlobals->curtime - m_flLastPaintTime > 0.05f)
	{
