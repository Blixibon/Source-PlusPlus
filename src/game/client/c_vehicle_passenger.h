...
public:
	...
	{ 
		...
		return m_hPassenger[nRole-1].Get(); 
	}
...
private:
	...
	CHandle< C_BasePlayer >	m_hPassenger[LAST_SHARED_VEHICLE_ROLE-1];

	CHandle< C_BasePlayer >	m_hPrevPassenger[LAST_SHARED_VEHICLE_ROLE-1];
