...
#include "cbase.h"
#include "hud.h"
#include "lazuulclientscoreboard.h"
#include "c_team.h"
...
enum EScoreboardSections
{
	...
	SCORESECTION_MILITARY,
	SCORESECTION_ZOMBIES,
...
// Purpose: Konstructor
//-----------------------------------------------------------------------------
CLazClientScoreBoardDialog::CLazClientScoreBoardDialog(IViewPort *pViewPort):CClientScoreBoardDialog(pViewPort)
{
}
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CLazClientScoreBoardDialog::~CLazClientScoreBoardDialog()
{
}
...
//-----------------------------------------------------------------------------
void CLazClientScoreBoardDialog::PaintBackground()
{
...
//-----------------------------------------------------------------------------
void CLazClientScoreBoardDialog::PaintBorder()
{
	int x1, x2, y1, y2;
...
//-----------------------------------------------------------------------------
void CLazClientScoreBoardDialog::ApplySchemeSettings( vgui::IScheme *pScheme )
{
...
//-----------------------------------------------------------------------------
void CLazClientScoreBoardDialog::InitScoreboardSections()
{
	m_pPlayerList->SetBgColor( Color(0, 0, 0, 0) );
	m_pPlayerList->SetBorder(NULL);
	...
	if (LazuulRules()->GetNumTeams() == 1)
	{
		AddSection(TYPE_TEAM, LazuulRules()->GetProtaganistTeam());
	}
	else if ( LazuulRules()->GetNumTeams() == 2 )
	{
...
//-----------------------------------------------------------------------------
void CLazClientScoreBoardDialog::UpdateTeamInfo()
{
	if ( g_PR == NULL )
		return;
...
//-----------------------------------------------------------------------------
void CLazClientScoreBoardDialog::AddHeader()
{
	// add the top header
...
//-----------------------------------------------------------------------------
void CLazClientScoreBoardDialog::AddSection(int teamType, int teamNumber)
{
	HFont hFallbackFont = scheme()->GetIScheme( GetScheme() )->GetFont( "DefaultVerySmallFallBack", false );
...
int CLazClientScoreBoardDialog::GetSectionFromTeamNumber( int teamNumber )
{
	switch ( teamNumber )
	{
	case TEAM_COMBINE:
...
//-----------------------------------------------------------------------------
bool CLazClientScoreBoardDialog::GetPlayerScoreInfo(int playerIndex, KeyValues *kv)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CLazClientScoreBoardDialog::UpdatePlayerInfo()
{
