...
enum
{
	...
	MP_CONCEPT_PLAYER_RELOAD,				// "TLK_PLAYER_RELOAD"
	MP_CONCEPT_PLAYER_FOLLOW,				// "TLK_PLAYER_FOLLOW"
	MP_CONCEPT_PLAYER_LEAD,					// "TLK_PLAYER_LEAD"

	MP_CONCEPT_GENERATOR_OFFLINE,			// "TLK_CP_GENERATOR_OFFLINE"
