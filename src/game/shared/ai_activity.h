...
//===========================
	...
	ACT_DOD_DEFUSE_TNT,
		...
		ACT_HL2MP_SWIM_CAMERA,
			...
			ACT_BMMP_IDLE,
			ACT_BMMP_RUN,
			ACT_BMMP_IDLE_CROUCH,
			ACT_BMMP_WALK_CROUCH,
			ACT_BMMP_GESTURE_RANGE_ATTACK,
			ACT_BMMP_GESTURE_RELOAD,
			ACT_BMMP_JUMP_START,
			ACT_BMMP_SWIM,
			ACT_BMMP_LADDER,
			...
			ACT_BMMP_GESTURE_RELOAD_GLUON,
			ACT_BMMP_JUMP_START_GLUON,
			ACT_BMMP_SWIM_GLUON,
			ACT_BMMP_LADDER_GLUON,
				...
				ACT_BMMP_GESTURE_RELOAD_HIVEHAND,
				ACT_BMMP_JUMP_START_HIVEHAND,
				ACT_BMMP_SWIM_HIVEHAND,
				ACT_BMMP_LADDER_HIVEHAND,
			...
			ACT_BMMP_GESTURE_RELOAD_SATCHEL,
			ACT_BMMP_JUMP_START_SATCHEL,
			ACT_BMMP_SWIM_SATCHEL,
			ACT_BMMP_LADDER_SATCHEL,
