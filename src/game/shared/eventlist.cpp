...
void EventList_RegisterSharedEvents( void )
{
	...
	REGISTER_SHARED_ANIMEVENT(AE_NPC_DEATHSOUND, AE_TYPE_SERVER);
	...
	REGISTER_SHARED_ANIMEVENT(AE_NPC_ITEM_ATTACH, AE_TYPE_SERVER);
	REGISTER_SHARED_ANIMEVENT(AE_NPC_ITEM_DROP, AE_TYPE_SERVER);
	REGISTER_SHARED_ANIMEVENT(AE_NPC_ITEM_REMOVE, AE_TYPE_SERVER);
	...
	REGISTER_SHARED_ANIMEVENT( AE_WPN_PLAYWPNSOUND, AE_TYPE_CLIENT | AE_TYPE_SERVER | AE_TYPE_WEAPON);
	...
	REGISTER_SHARED_ANIMEVENT(AE_CL_EJECTBRASS_SCRIPT, AE_TYPE_CLIENT);

	REGISTER_SHARED_ANIMEVENT(AE_METROPOLICE_START_DEPLOY, AE_TYPE_SERVER);
	REGISTER_SHARED_ANIMEVENT(AE_METROPOLICE_DEPLOY_MANHACK, AE_TYPE_SERVER);

	REGISTER_SHARED_ANIMEVENT(AE_NPC_RESPONSE, AE_TYPE_SERVER);
	REGISTER_SHARED_ANIMEVENT(AE_NPC_RESPONSE_FORCED, AE_TYPE_SERVER);

	REGISTER_SHARED_ANIMEVENT(AE_VM_ENABLE_BODYGROUP, AE_TYPE_SERVER | AE_TYPE_CLIENT);
	REGISTER_SHARED_ANIMEVENT(AE_VM_DISABLE_BODYGROUP, AE_TYPE_SERVER | AE_TYPE_CLIENT);
	REGISTER_SHARED_ANIMEVENT(AE_VM_BODYGROUP_SET, AE_TYPE_SERVER | AE_TYPE_CLIENT);
}