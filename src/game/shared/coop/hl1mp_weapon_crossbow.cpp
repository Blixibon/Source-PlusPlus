...
LINK_ENTITY_TO_CLASS( crossbow_bolt_hl1, CHL1CrossbowBolt );
...
CHL1CrossbowBolt *CHL1CrossbowBolt::BoltCreate( const Vector &vecOrigin, const QAngle &angAngles, CBasePlayer *pentOwner )
{
	...
	CHL1CrossbowBolt *pBolt = (CHL1CrossbowBolt *)CreateEntityByName( "crossbow_bolt_hl1" );
...
class CHL1WeaponCrossbow : public CCoopHL1CombatWeapon
{
	DECLARE_CLASS( CHL1WeaponCrossbow, CCoopHL1CombatWeapon);
public:
...
LINK_ENTITY_TO_CLASS( weapon_crossbow_hl1, CHL1WeaponCrossbow );
