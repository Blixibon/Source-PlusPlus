...
class CWeaponHgun : public CCoopHL1CombatWeapon
{
	DECLARE_CLASS( CWeaponHgun, CCoopHL1CombatWeapon);
public:
	...
	virtual int GetWeaponID(void) const { return HLSS_WEAPON_ID_HIVEHAND; }
