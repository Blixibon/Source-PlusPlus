...
class CWeapon_SLAM : public CWeaponCoopBaseHLCombat
{
public:
	DECLARE_CLASS( CWeapon_SLAM, CWeaponCoopBaseHLCombat);

	DECLARE_NETWORKCLASS(); 
	DECLARE_PREDICTABLE();

	virtual int GetWeaponID(void) const { return HLSS_WEAPON_ID_SLAM; }
