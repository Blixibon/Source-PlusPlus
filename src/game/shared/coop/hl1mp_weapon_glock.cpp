...
class CWeaponGlock : public CCoopHL1CombatWeapon
{
	DECLARE_CLASS( CWeaponGlock, CCoopHL1CombatWeapon);
...
public:
	...
	virtual int GetWeaponID(void) const { return HLSS_WEAPON_ID_PISTOL; }
