...
class CWeaponGauss : public CCoopHL1CombatWeapon
{
	DECLARE_CLASS( CWeaponGauss, CCoopHL1CombatWeapon);
public:
	...
	virtual int GetWeaponID(void) const { return HLSS_WEAPON_ID_GAUSS; }
...
void CWeaponGauss::StartFire( void )
{
	...
	m_flPlayAftershock = gpGlobals->curtime + SharedRandomFloat("GaussAftershockRandom", 0.3, 0.8);
