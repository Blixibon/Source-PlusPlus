...
class CWeaponSatchel : public CCoopHL1CombatWeapon
{
	DECLARE_CLASS( CWeaponSatchel, CCoopHL1CombatWeapon);
...
public:
	...
	virtual int GetWeaponID(void) const { return HLSS_WEAPON_ID_SATCHEL; }
