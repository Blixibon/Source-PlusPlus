...
#ifdef CLIENT_DLL
    #define CBMSWeaponShotgun C_BMSWeaponShotgun
#else
    #include "soundent.h"
...
class CBMSWeaponShotgun : public CWeaponCoopBaseHLCombat
{
public:
	DECLARE_CLASS( CBMSWeaponShotgun, CWeaponCoopBaseHLCombat );
...
//	void WeaponIdle( void );
	...
	CBMSWeaponShotgun(void);

private:
	CBMSWeaponShotgun( const CBMSWeaponShotgun & );
};

LINK_ENTITY_TO_CLASS( weapon_shotgun_bms, CBMSWeaponShotgun );
PRECACHE_WEAPON_REGISTER(weapon_shotgun_bms);

IMPLEMENT_NETWORKCLASS_ALIASED( BMSWeaponShotgun, DT_BMSWeaponShotgun )

BEGIN_NETWORK_TABLE(CBMSWeaponShotgun, DT_BMSWeaponShotgun)
#ifdef CLIENT_DLL
...
#ifdef CLIENT_DLL
BEGIN_PREDICTION_DATA( CBMSWeaponShotgun )
...
END_PREDICTION_DATA()
#else
BEGIN_DATADESC( CBMSWeaponShotgun )
...
//acttable_t	CBMSWeaponShotgun::m_acttable[] = 
//{
...
//IMPLEMENT_ACTTABLE(CBMSWeaponShotgun);

void CBMSWeaponShotgun::Precache( void )
{
	BaseClass::Precache();
}
...
// Input  : *pOperator - 
//-----------------------------------------------------------------------------
void CBMSWeaponShotgun::FireNPCPrimaryAttack( CBaseCombatCharacter *pOperator, bool bUseWeaponAngles )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBMSWeaponShotgun::Operator_ForceNPCFire( CBaseCombatCharacter *pOperator, bool bSecondary )
{
...
// Output :
//-----------------------------------------------------------------------------
void CBMSWeaponShotgun::Operator_HandleAnimEvent( animevent_t *pEvent, CBaseCombatCharacter *pOperator )
{
	switch( pEvent->event )
	{
...
//-----------------------------------------------------------------------------
float CBMSWeaponShotgun::GetMinRestTime()
{
#ifndef CLIENT_DLL
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
float CBMSWeaponShotgun::GetMaxRestTime()
{
#ifndef CLIENT_DLL
	if( hl2_episodic.GetBool() && GetOwner() && GetOwner()->Classify() == CLASS_COMBINE )
	{
...
//-----------------------------------------------------------------------------
float CBMSWeaponShotgun::GetFireRate()
{
#ifndef CLIENT_DLL
	if( hl2_episodic.GetBool() && GetOwner() && GetOwner()->Classify() == CLASS_COMBINE )
	{
...
// Output :
//-----------------------------------------------------------------------------
bool CBMSWeaponShotgun::StartReload( void )
{
...
// Output :
//-----------------------------------------------------------------------------
bool CBMSWeaponShotgun::Reload( void )
{
...
// Output :
//-----------------------------------------------------------------------------
void CBMSWeaponShotgun::FinishReload( void )
{
...
// Output :
//-----------------------------------------------------------------------------
void CBMSWeaponShotgun::FillClip( void )
{
	CBaseCombatCharacter *pOwner  = GetOwner();
...
// Output :
//-----------------------------------------------------------------------------
void CBMSWeaponShotgun::Pump( void )
{
	CBaseCombatCharacter *pOwner  = GetOwner();
...
//
//-----------------------------------------------------------------------------
void CBMSWeaponShotgun::DryFire( void )
{
	WeaponSound(EMPTY);
...
//
//-----------------------------------------------------------------------------
void CBMSWeaponShotgun::PrimaryAttack( void )
{
...
//
//-----------------------------------------------------------------------------
void CBMSWeaponShotgun::SecondaryAttack( void )
{
	// Only the player fires this way so we can cast
	CBasePlayer *pPlayer = ToBasePlayer( GetOwner() );
...
//-----------------------------------------------------------------------------
void CBMSWeaponShotgun::ItemPostFrame( void )
{
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CBMSWeaponShotgun::CBMSWeaponShotgun( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBMSWeaponShotgun::ItemHolsterFrame( void )
{
	// Must be player held
...
//==================================================
/*
void CBMSWeaponShotgun::WeaponIdle( void )
{
	//Only the player fires this way so we can cast
