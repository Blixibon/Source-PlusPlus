...
void ActivityList_RegisterSharedActivities( void )
{
	...
	REGISTER_SHARED_ACTIVITY(ACT_VM_INSPECT_ALT);
...
//===========================
	...
	REGISTER_SHARED_ACTIVITY(ACT_AHL_DUCKJUMP);

	// BMMP
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_RUN);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_CROUCH);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_WALK_CROUCH);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RANGE_ATTACK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RELOAD);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_JUMP_START);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_SWIM);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_LADDER);

	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_MP5);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_RUN_MP5);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_CROUCH_MP5);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_WALK_CROUCH_MP5);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RANGE_ATTACK_MP5);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RELOAD_MP5);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_JUMP_START_MP5);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_SWIM_MP5);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_LADDER_MP5);

	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_GLOCK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_RUN_GLOCK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_CROUCH_GLOCK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_WALK_CROUCH_GLOCK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RANGE_ATTACK_GLOCK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RELOAD_GLOCK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_JUMP_START_GLOCK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_SWIM_GLOCK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_LADDER_GLOCK);

	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_TAU);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_RUN_TAU);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_CROUCH_TAU);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_WALK_CROUCH_TAU);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RANGE_ATTACK_TAU);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RELOAD_TAU);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_JUMP_START_TAU);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_SWIM_TAU);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_LADDER_TAU);

	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_GLUON);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_RUN_GLUON);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_CROUCH_GLUON);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_WALK_CROUCH_GLUON);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RANGE_ATTACK_GLUON);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RELOAD_GLUON);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_JUMP_START_GLUON);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_SWIM_GLUON);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_LADDER_GLUON);

	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_HIVEHAND);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_RUN_HIVEHAND);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_CROUCH_HIVEHAND);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_WALK_CROUCH_HIVEHAND);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RANGE_ATTACK_HIVEHAND);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RELOAD_HIVEHAND);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_JUMP_START_HIVEHAND);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_SWIM_HIVEHAND);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_LADDER_HIVEHAND);

	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_SATCHEL);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_RUN_SATCHEL);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_CROUCH_SATCHEL);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_WALK_CROUCH_SATCHEL);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RANGE_ATTACK_SATCHEL);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RELOAD_SATCHEL);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_JUMP_START_SATCHEL);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_SWIM_SATCHEL);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_LADDER_SATCHEL);

	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_SNARK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_RUN_SNARK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_CROUCH_SNARK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_WALK_CROUCH_SNARK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RANGE_ATTACK_SNARK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RELOAD_SNARK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_JUMP_START_SNARK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_SWIM_SNARK);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_LADDER_SNARK);

	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_TRIPMINE);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_RUN_TRIPMINE);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_IDLE_CROUCH_TRIPMINE);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_WALK_CROUCH_TRIPMINE);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RANGE_ATTACK_TRIPMINE);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_GESTURE_RELOAD_TRIPMINE);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_JUMP_START_TRIPMINE);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_SWIM_TRIPMINE);
	REGISTER_SHARED_ACTIVITY(ACT_BMMP_LADDER_TRIPMINE);
