...
#ifndef CLIENT_DLL
extern Class_T g_aTeamPlayerClasses[TF_TEAM_COUNT];
#endif // !1


#define TF_TEAM_RED TEAM_REBELS
#define TF_TEAM_BLUE TEAM_COMBINE
#define TF_TEAM_GREEN TEAM_MILITARY
#define TF_TEAM_YELLOW TEAM_ZOMBIES
...
#define MASK_ALLTEAMS (CONTENTS_COMBINETEAM|CONTENTS_REBELTEAM|CONTENTS_GREENTEAM|CONTENTS_YELLOWTEAM)
#define MASK_REDTEAMSOLID (CONTENTS_COMBINETEAM|CONTENTS_GREENTEAM|CONTENTS_YELLOWTEAM)
#define MASK_BLUETEAMSOLID (CONTENTS_REBELTEAM|CONTENTS_GREENTEAM|CONTENTS_YELLOWTEAM)
#define MASK_GREENTEAMSOLID (CONTENTS_COMBINETEAM|CONTENTS_REBELTEAM|CONTENTS_YELLOWTEAM)
#define MASK_YELLOWTEAMSOLID (CONTENTS_COMBINETEAM|CONTENTS_REBELTEAM|CONTENTS_GREENTEAM)
...
enum
{
	TF_LOADOUT_SLOT_MELEE = 0,
	TF_LOADOUT_SLOT_PISTOL,
	TF_LOADOUT_SLOT_SMG,
	TF_LOADOUT_SLOT_RIFLE,
	TF_LOADOUT_SLOT_EXPLOSIVE,
