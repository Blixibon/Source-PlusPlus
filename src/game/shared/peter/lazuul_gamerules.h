...
class CLazuul : public CTeamplayRoundBasedRules, public IHalfLife2, public IPortalRules
{
...
public:
	...
	virtual bool ShouldRemoveRadio(void);
...
enum LazAchievements_e
{
	LAZ_LAST_SHARED_ACHIEVEMENT = ACHIEVEMENT_TF_LAST_ORANGEBOX,
