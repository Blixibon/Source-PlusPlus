...
#define DMG_GENERIC			0Ui64			// generic damage -- do not use if you want players to flinch and bleed!
#define DMG_CRUSH			(1Ui64 << 0Ui64)	// crushed by falling or moving object. 
										// NOTE: It's assumed crush damage is occurring as a result of physics collision, so no extra physics force is generated by crush damage.
										// DON'T use DMG_CRUSH when damaging entities unless it's the result of a physics collision. You probably want DMG_CLUB instead.
#define DMG_BULLET			(1Ui64 << 1Ui64)	// shot
#define DMG_SLASH			(1Ui64 << 2Ui64)	// cut, clawed, stabbed
#define DMG_BURN			(1Ui64 << 3Ui64)	// heat burned
#define DMG_FREEZE			(1Ui64 << 4Ui64)	// frozen
#define DMG_FALL			(1Ui64 << 5Ui64)	// fell too far
#define DMG_BLAST			(1Ui64 << 6Ui64)	// explosive blast damage
#define DMG_CLUB			(1Ui64 << 7Ui64)	// crowbar, punch, headbutt
#define DMG_SHOCK			(1Ui64 << 8Ui64)	// electric shock
#define DMG_SONIC			(1Ui64 << 9Ui64)	// sound pulse shockwave
#define DMG_ENERGYBEAM		(1Ui64 << 10Ui64)	// laser or other high energy beam 
#define DMG_PREVENT_PHYSICS_FORCE		(1Ui64 << 11Ui64)	// Prevent a physics force 
#define DMG_NEVERGIB		(1Ui64 << 12Ui64)	// with this bit OR'd in, no damage type will be able to gib victims upon death
#define DMG_ALWAYSGIB		(1Ui64 << 13Ui64)	// with this bit OR'd in, any damage type can be made to gib victims upon death.
#define DMG_DROWN			(1Ui64 << 14Ui64)	// Drowning


#define DMG_PARALYZE		(1Ui64 << 15Ui64)	// slows affected creature down
#define DMG_NERVEGAS		(1Ui64 << 16Ui64)	// nerve toxins, very bad
#define DMG_POISON			(1Ui64 << 17Ui64)	// blood poisoning - heals over time like drowning damage
#define DMG_RADIATION		(1Ui64 << 18Ui64)	// radiation exposure
#define DMG_DROWNRECOVER	(1Ui64 << 19Ui64)	// drowning recovery
#define DMG_ACID			(1Ui64 << 20Ui64)	// toxic chemicals or acid burns
#define DMG_SLOWBURN		(1Ui64 << 21Ui64)	// in an oven
#define DMG_SLOWFREEZE		(1Ui64<<22Ui64)		
...
#define DMG_DIRECT			(1Ui64<<28Ui64)
#define DMG_BUCKSHOT		(1Ui64<<29Ui64)		// not quite a bullet. Little, rounder, different.

#define DMG_VEHICLE			(1Ui64<<30Ui64)		// hit by a vehicle
#define DMG_REMOVENORAGDOLL	(1Ui64<<31Ui64)		// with this bit OR'd in, no ragdoll will be created, and the target will be quietly removed.
...
#define DMG_LASTGENERICFLAG	0x0000000080000000Ui64
...
#ifndef CLIENT_DLL
#if defined(INSOURCE_BOTS) || defined(NEXT_BOT)
static const char *g_charBotNames[] =
{
	"Steve",
	"Markus",
	"Nathan",
...
enum Announcement_e
{
	...
	ANNOUNCE_ROUND_TIMER_60SECS,
	ANNOUNCE_ROUND_TIMER_30SECS,
	ANNOUNCE_ROUND_TIMER_10SECS,
	ANNOUNCE_ROUND_TIMER_5SECS,
	ANNOUNCE_ROUND_TIMER_4SECS,
	ANNOUNCE_ROUND_TIMER_3SECS,
	ANNOUNCE_ROUND_TIMER_2SECS,
	ANNOUNCE_ROUND_TIMER_1SECS,
	ANNOUNCE_ROUND_OVER,

	ANNOUNCE_ROUND_SETUP_60SECS,
	ANNOUNCE_ROUND_SETUP_30SECS,
	ANNOUNCE_ROUND_SETUP_10SECS,
	ANNOUNCE_ROUND_SETUP_5SECS,
	ANNOUNCE_ROUND_SETUP_4SECS,
	ANNOUNCE_ROUND_SETUP_3SECS,
	ANNOUNCE_ROUND_SETUP_2SECS,
	ANNOUNCE_ROUND_SETUP_1SECS,
	ANNOUNCE_ROUND_START_BELL,

	ANNOUNCE_ROUND_TIMER_TIME_ADDED,
	ANNOUNCE_ROUND_TIMER_TIME_ADDED_LOSER,
	ANNOUNCE_ROUND_TIMER_TIME_ADDED_WINNER,

	ANNOUNCE_ROUND_TIMER_15MIN,
	ANNOUNCE_ROUND_TIMER_10MIN,
	ANNOUNCE_ROUND_TIMER_5MIN,
	ANNOUNCE_ROUND_TIMER_4MIN,
	ANNOUNCE_ROUND_TIMER_3MIN,
	ANNOUNCE_ROUND_TIMER_2MIN,
	//ANNOUNCE_ROUND_TIMER_1MIN,
