...
lumpfileheader_t CMapLoadHelper::s_LumpHeaders[] = { 0 };
FileHandle_t CMapLoadHelper::s_LumpFileHandles[] = { FILESYSTEM_INVALID_HANDLE };
...
int GetLeafForOrigin(const Vector& org)
{
	return CM_PointLeafnum(org);
}
