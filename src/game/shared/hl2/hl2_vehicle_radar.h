...
#define LOCATOR_CONTACT_TYPE_BITS	4 // Max 8 types of contacts (for networking)
...
enum // If we have more than 16 types of contacts, LOCATOR_CONTACT_TYPE_BITS
{
	...
	LOCATOR_CONTACT_MAGNUSSEN_RDU,
	LOCATOR_CONTACT_DOG,
	LOCATOR_CONTACT_ALLY_INSTALLATION,
	LOCATOR_CONTACT_ENEMY,			// 'regular' sized enemy (Hunter)
	LOCATOR_CONTACT_LARGE_ENEMY, // Large enemy (Strider)
	LOCATOR_CONTACT_RADIATION,
	LOCATOR_CONTACT_PLAYER_VEHICLE,
};
//TE120--
#endif