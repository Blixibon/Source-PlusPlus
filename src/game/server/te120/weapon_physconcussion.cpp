...
LINK_ENTITY_TO_CLASS( player_pickup_conc, CPlayerPickupControllerConcussion );
...
void PlayerPickupConcObject( CBasePlayer *pPlayer, CBaseEntity *pObject )
{
	...
	CPlayerPickupControllerConcussion *pController = (CPlayerPickupControllerConcussion *)CBaseEntity::Create( "player_pickup_conc", pObject->GetAbsOrigin(), vec3_angle, pPlayer );
