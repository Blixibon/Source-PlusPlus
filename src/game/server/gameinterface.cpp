...
IGameEventManager* gameeventmanagerOLD = NULL;
		...
		CGlobalVars *pGlobals)
{
	...
	if ( (gameeventmanager = (IGameEventManager2 *)appSystemFactory(INTERFACEVERSION_GAMEEVENTSMANAGER2,NULL)) == NULL )
		return false;
	gameeventmanagerOLD = (IGameEventManager*)appSystemFactory(INTERFACEVERSION_GAMEEVENTSMANAGER, NULL);
...
static TITLECOMMENT gTitleComments[] =
{
	...
	{ "hc_t0a0", "#HC_Title" },
	{ "bm_c0a0", "#BMS_Chapter1_Title" },
	{ "bm_c1a0", "#BMS_Chapter2_Title" },
	{ "bm_c1a1", "#BMS_Chapter3_Title" },
	{ "bm_c1a2", "#BMS_Chapter4_Title" },
	{ "bm_c1a3", "#BMS_Chapter5_Title" },
	{ "bm_c1a4", "#BMS_Chapter6_Title" },
	{ "bm_c2a1", "#BMS_Chapter7_Title" },
	{ "bm_c2a2", "#BMS_Chapter8_Title" },
	{ "bm_c2a3", "#BMS_Chapter9_Title" },
	{ "bm_c2a4h", "#BMS_Chapter11_Title" },	// These must appear before "C2A4" so all other map names starting with C2A4 get that title
	{ "bm_c2a4e", "#BMS_Chapter11_Title" },
	{ "bm_c2a4f", "#BMS_Chapter11_Title" },
	{ "bm_c2a4g", "#BMS_Chapter11_Title" },
	{ "bm_c2a4", "#BMS_Chapter10_Title" },
	{ "bm_c2a5", "#BMS_Chapter12_Title" },
	{ "bm_c3a1", "#BMS_Chapter13_Title" },
	{ "bm_c3a2", "#BMS_Chapter14_Title" },
	/*{ "bm_c4a1", "xen" },
	{ "bm_c4a2", "gon_lair"  },
	{ "bm_c4a3", "interloper"},
	{ "bm_c4a4", "nihil"  },
