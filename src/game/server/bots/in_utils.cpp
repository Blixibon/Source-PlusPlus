...
//================================================================================
//================================================================================
CBasePlayer *Utils::GetClosestPlayer(const Vector &vecPosition, float *distance, CBasePlayer *pIgnore, int team)
{
...
//================================================================================
bool Utils::IsSpotOccupied(const Vector &vecPosition, CBasePlayer *pIgnore, float closeRange, int avoidTeam)
{
    float distance;
	CBasePlayer *pPlayer = Utils::GetClosestPlayer(vecPosition, &distance, pIgnore, avoidTeam);
...
CBasePlayer * Utils::GetClosestPlayerByClass(const Vector & vecPosition, Class_T classify, float *distance, CBasePlayer *pIgnore)
{
	CBasePlayer *pClosest = NULL;
    float closeDist = 999999999999.9f;
...
bool Utils::IsSpotOccupiedByClass(const Vector &vecPosition, Class_T classify, CBasePlayer * pIgnore, float closeRange)
{
    float distance;
	CBasePlayer *pPlayer = Utils::GetClosestPlayerByClass(vecPosition, classify, &distance, pIgnore);
...
//================================================================================
bool Utils::IsCrossingLineOfFire(const Vector &vecStart, const Vector &vecFinish, CBasePlayer *pIgnore, int ignoreTeam)
{
    for ( int i = 1; i <= gpGlobals->maxClients; ++i ) {
		CBasePlayer *pPlayer = ToInPlayer(UTIL_PlayerByIndex(i));
...
void CSpotCriteria::SetPlayer(CBasePlayer * pPlayer)
{
    m_pPlayer = pPlayer;
