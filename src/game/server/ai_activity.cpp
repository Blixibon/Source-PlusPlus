...
void CAI_BaseNPC::InitDefaultActivitySR(void) 
{
	...
	ADD_ACTIVITY_TO_SR(ACT_VM_INSPECT_ALT);
...
//===========================
	...
	ADD_ACTIVITY_TO_SR(ACT_AHL_DUCKJUMP);

	// BMMP
	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_RUN);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_CROUCH);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_WALK_CROUCH);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RANGE_ATTACK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RELOAD);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_JUMP_START);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_SWIM);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_LADDER);

	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_MP5);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_RUN_MP5);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_CROUCH_MP5);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_WALK_CROUCH_MP5);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RANGE_ATTACK_MP5);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RELOAD_MP5);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_JUMP_START_MP5);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_SWIM_MP5);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_LADDER_MP5);

	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_GLOCK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_RUN_GLOCK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_CROUCH_GLOCK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_WALK_CROUCH_GLOCK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RANGE_ATTACK_GLOCK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RELOAD_GLOCK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_JUMP_START_GLOCK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_SWIM_GLOCK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_LADDER_GLOCK);

	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_TAU);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_RUN_TAU);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_CROUCH_TAU);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_WALK_CROUCH_TAU);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RANGE_ATTACK_TAU);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RELOAD_TAU);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_JUMP_START_TAU);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_SWIM_TAU);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_LADDER_TAU);

	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_GLUON);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_RUN_GLUON);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_CROUCH_GLUON);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_WALK_CROUCH_GLUON);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RANGE_ATTACK_GLUON);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RELOAD_GLUON);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_JUMP_START_GLUON);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_SWIM_GLUON);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_LADDER_GLUON);

	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_HIVEHAND);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_RUN_HIVEHAND);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_CROUCH_HIVEHAND);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_WALK_CROUCH_HIVEHAND);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RANGE_ATTACK_HIVEHAND);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RELOAD_HIVEHAND);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_JUMP_START_HIVEHAND);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_SWIM_HIVEHAND);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_LADDER_HIVEHAND);

	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_SATCHEL);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_RUN_SATCHEL);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_CROUCH_SATCHEL);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_WALK_CROUCH_SATCHEL);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RANGE_ATTACK_SATCHEL);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RELOAD_SATCHEL);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_JUMP_START_SATCHEL);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_SWIM_SATCHEL);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_LADDER_SATCHEL);

	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_SNARK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_RUN_SNARK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_CROUCH_SNARK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_WALK_CROUCH_SNARK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RANGE_ATTACK_SNARK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RELOAD_SNARK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_JUMP_START_SNARK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_SWIM_SNARK);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_LADDER_SNARK);

	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_TRIPMINE);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_RUN_TRIPMINE);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_IDLE_CROUCH_TRIPMINE);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_WALK_CROUCH_TRIPMINE);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RANGE_ATTACK_TRIPMINE);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_GESTURE_RELOAD_TRIPMINE);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_JUMP_START_TRIPMINE);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_SWIM_TRIPMINE);
	ADD_ACTIVITY_TO_SR(ACT_BMMP_LADDER_TRIPMINE);
