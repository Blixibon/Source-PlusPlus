...
//	void WeaponIdle( void );
	...
	WeaponTypes GetWeaponType() { return WEAPON_TYPE_SHOTGUN; }
};
...
//End readiness activities
	...
	{ ACT_MP_STAND_IDLE,				ACT_DOD_STAND_AIM_MP40,					false },
	{ ACT_MP_CROUCH_IDLE,				ACT_DOD_CROUCH_IDLE_MP40,				false },
	{ ACT_MP_RUN,						ACT_DOD_WALK_IDLE_MP40,					false },
	{ ACT_MP_CROUCHWALK,				ACT_DOD_CROUCHWALK_IDLE_MP40,			false },
	{ ACT_MP_ATTACK_STAND_PRIMARYFIRE,	ACT_DOD_PRIMARYATTACK_MP40,				false },
	{ ACT_MP_ATTACK_CROUCH_PRIMARYFIRE,	ACT_DOD_PRIMARYATTACK_MP40,				false },
...
//-----------------------------------------------------------------------------
float CWeaponAutoshotgun::GetMinRestTime()
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
float CWeaponAutoshotgun::GetMaxRestTime()
{
	if( hl2_episodic.GetBool() && GetOwner() && GetOwner()->Classify() == CLASS_COMBINE )
	{
		return 1.5f;
...
//-----------------------------------------------------------------------------
float CWeaponAutoshotgun::GetFireRate()
{
	if( hl2_episodic.GetBool() && GetOwner() && GetOwner()->Classify() == CLASS_COMBINE )
	{
		return 0.8f;
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponAutoshotgun::StartReload( void )
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponAutoshotgun::FinishReload( void )
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponAutoshotgun::Pump( void )
{
	CBaseCombatCharacter *pOwner  = GetOwner();
...
void CWeaponAutoshotgun::PrimaryAttack( void )
{
	...
	m_flNextPrimaryAttack = gpGlobals->curtime + 0.25f; //SequenceDuration()
	m_iClip1 -= 1;
...
//-----------------------------------------------------------------------------
void CWeaponAutoshotgun::ItemPostFrame( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAutoshotgun::ItemHolsterFrame( void )
{
	// Must be player held
