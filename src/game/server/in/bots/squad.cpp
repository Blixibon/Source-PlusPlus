...
#define FOR_EACH_MEMBER( code ) FOR_EACH_VEC( m_nMembers, it ) { \
    CBasePlayer *pMember = GetMember( it ); \
    if ( !pMember ) \
        continue; \
    code \
}
...
//================================================================================
void CSquad::SetLeader(CBasePlayer *member)
{
...
//================================================================================
int CSquad::GetMemberIndex(CBasePlayer *member)
{
	FOR_EACH_MEMBER(
		{
			if (pMember == member)
...
//================================================================================
CBasePlayer *CSquad::GetMember(int index)
{
...
//================================================================================
CBasePlayer * CSquad::GetRandomMember()
{
	if (IsEmpty())
		return NULL;
...
//================================================================================
bool CSquad::IsMember(CBasePlayer *pMember)
{
...
//================================================================================
void CSquad::AddMember(CBasePlayer *pMember)
{
	if (IsMember(pMember))
		return;
...
//================================================================================
//================================================================================
void CSquad::RemoveMember(CBasePlayer *member)
{
...
//================================================================================
bool CSquad::IsSomeoneLooking(CBaseEntity * pTarget, CBasePlayer *pIgnore)
{
	FOR_EACH_VEC(m_nMembers, it)
	{
		CBasePlayer *pMember = GetMember(it);
...
//================================================================================
bool CSquad::IsSomeoneLooking(const Vector & vecTarget, CBasePlayer *pIgnore)
{
	FOR_EACH_VEC(m_nMembers, it)
	{
		CBasePlayer *pMember = GetMember(it);
...
//================================================================================
bool CSquad::IsSomeoneGoing(const Vector & vecDestination, CBasePlayer *pIgnore)
{
	FOR_EACH_VEC(m_nMembers, it)
	{
		CBasePlayer *pMember = GetMember(it);
...
//================================================================================
bool CSquad::IsSquadEnemy(CBaseEntity *pEntity, CBasePlayer *pIgnore)
{
	FOR_EACH_MEMBER(
		{
			if (pMember == pIgnore)
...
//================================================================================
//================================================================================
void CSquad::ReportTakeDamage(CBasePlayer *member, const CTakeDamageInfo &info)
{
	FOR_EACH_MEMBER(
		{
...
//================================================================================
//================================================================================
void CSquad::ReportDeath(CBasePlayer *member, const CTakeDamageInfo &info)
{
	FOR_EACH_MEMBER(
		{
			// No lo queremos comunicar a nosotros mismos...
...
//================================================================================
//================================================================================
void CSquad::ReportEnemy(CBasePlayer *member, CBaseEntity *pEnemy)
{
	FOR_EACH_MEMBER(
		{
			// No lo queremos comunicar a nosotros mismos...
	...
	if (GetController()) {
		...
		if (pEnemy->IsPlayer()) {
			CBasePlayer *pPlayer = (CBasePlayer *)pEnemy;
			Assert(pPlayer);
