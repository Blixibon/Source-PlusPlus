...
//================================================================================
//================================================================================
bool CBotManager::IsSpotReserved(const Vector & vecSpot, CBasePlayer * pPlayer) const
{
	if (!pPlayer) {
...
//================================================================================
//================================================================================
bool CBotManager::IsSpotReserved(const Vector & vecSpot, int team, CBasePlayer *pIgnore) const
{
