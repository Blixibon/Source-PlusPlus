...
// Derived classes
//typedef CBasePlayer CBasePlayer;
...
//#define SKILL_HARDEST SKILL_IMPOSIBLE

enum {
	SKILL_EASIEST = SKILL_EASY,
	SKILL_VERY_HARD = SKILL_HARD + 1,
	SKILL_ULTRA_HARD,
	SKILL_IMPOSSIBLE,

	SKILL_HARDEST = SKILL_IMPOSSIBLE,
	SKILL_HARDEST_EXTERNAL = SKILL_HARD,
};

#define SKILL_IMPOSIBLE SKILL_IMPOSSIBLE
...
#define DECLARE_SERVER_CMD( name, value, description ) DECLARE_REPLICATED_COMMAND( name, value, description )
