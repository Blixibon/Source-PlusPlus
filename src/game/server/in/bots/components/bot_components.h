...
public:
    ...
    virtual bool ShouldHelpDejectedFriend( CBasePlayer *pDejected ) const;
    virtual CBasePlayer *GetClosestDejectedFriend(bool prioritizeHumans = true, float *distance = NULL) const;
