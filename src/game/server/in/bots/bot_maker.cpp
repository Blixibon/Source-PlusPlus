...
static ConVar ai_inhibit_spawners("ai_inhibit_spawners", "0", FCVAR_CHEAT);
...
{
	CBasePlayer *pPlayer = ToInPlayer(pVictim);
...
void CBotSpawn::SetUpBot()
{
	...
	if (m_iBotTeam == 99) {
		...
		Warning("CBasePlayer::SetRandomTeam not implemented!/n");
	}
	else {
